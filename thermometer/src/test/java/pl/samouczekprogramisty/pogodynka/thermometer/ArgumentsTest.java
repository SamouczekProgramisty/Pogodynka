...
public class ArgumentsTest {
    ...
    public void shouldParseUsername() {
        Arguments arguments = new Arguments("programName", "username", "password", "http://www.samouczekprogramisty.pl");
    ...
    public void shouldTrowExcpeptionOnInvalidURL() throws URISyntaxException {
        new Arguments("programName", "username", "password", "http://some_illegal_uri.pl?s=^");
    }
}